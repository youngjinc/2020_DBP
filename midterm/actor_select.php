<?php
    ...
    $actor = mysqli_real_escape_string($link, $_GET['actor']);
...
<body>
    <h2 style = "display:inline" ><a href="index.php" class = "search">NETFLIX 컨텐츠 조회 시스템</a> | <?=$actor?></h2> <h2 style = "display:inline"> 출연 컨텐츠 조회</h2>
    <table border="1">
        <tr>
            <th>type</th>
            <th>title</th>
