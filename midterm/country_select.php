<?php
    ...
    where info.country like  \"%".$country."%\"
...
<body>
    <h2 style = "display:inline" ><a href="index.php" class = "search">NETFLIX 컨텐츠 조회 시스템</a> | <?=$country?></h2> <h2 style = "display:inline"> 컨텐츠 조회</h2>
    <table border="1">
    <tr>
            <th>country</th>
            <th>type</th>
